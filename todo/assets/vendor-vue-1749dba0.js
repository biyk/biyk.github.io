import { f as fromPairs, c as componentSizes } from "./vendor-b885ec53.js";
/**
* @vue/shared v3.5.13
...
function computedWithControl(source, fn) {
  ...
  watch(source, update3, { flush: "sync" });
...
function useElementBounding(target, options = {}) {
  ...
  useResizeObserver(target, update3);
  watch(() => unrefElement(target), (ele) => !ele && update3());
  if (windowScroll)
...
export {
  ...
  isObject$1 as b,
  full_screen_default as b0,
  scale_to_original_default as b1,
  effectScope as b2,
  ...
  star_default as bm,
  circle_check_filled_default as bn,
  circle_close_filled_default as bo,
  info_filled_default as bp,
